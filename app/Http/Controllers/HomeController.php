...
class HomeController extends Controller
{
    ...
    public function home()
    {
        ...
        ->select('anime_reviews.review_title', 'anime_reviews.id', 'animes.english_title', 'animes.japanese_title', 'anime_reviews.review_text', 'user_details.user_avatar', 'anime_reviews.user_name' )
